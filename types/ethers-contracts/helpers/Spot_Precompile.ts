...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "../common.js"
  ...
  export interface Spot_PrecompileInterface extends Interface {
  ...
  export interface Spot_Precompile extends BaseContract {
    
    connect(runner?: ContractRunner | null): Spot_Precompile;
    waitForDeployment(): Promise<this>;

    interface: Spot_PrecompileInterface;
